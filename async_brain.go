...
/* ---=== Mutation ===--- */
// Произвольно меняем вес произвольного синапса нейрона N на случайную дельту (от -0.5 до 0.5).
// FIXME Хорошо бы сделать чаще больее маленькую дельту и реже большую - около 0.5 и -0.5
